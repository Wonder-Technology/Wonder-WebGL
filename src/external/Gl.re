...
[@bs.get]
external getCurrentProgram : webgl1Context => int = "CURRENT_PROGRAM";

[@bs.get]
external getBindingElementArrayBuffer : webgl1Context => int =
  "ELEMENT_ARRAY_BUFFER_BINDING";

[@bs.get]
external getBindingArrayBuffer : webgl1Context => int = "ARRAY_BUFFER_BINDING";
...
external pixelStoreiEnum : (int, enum) => unit = "pixelStorei";
